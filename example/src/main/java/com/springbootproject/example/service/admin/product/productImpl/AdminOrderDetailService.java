...
import com.springbootproject.example.service.admin.product.IAdminOrderDetailService;

@Service
public class AdminOrderDetailService implements IAdminOrderDetailService{
	
	@Autowired
	private AdminOrderRepository adminOrderRepository;

	public AdminOrderDetailService(AdminOrderRepository adminOrderRepository) {
