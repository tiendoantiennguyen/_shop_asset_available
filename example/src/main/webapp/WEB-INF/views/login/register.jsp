        ...
        <div class="container-fluid vh-100 overflow-auto">
            <div class="row vh-100 ">
                <div class="col-lg-6 bg-gray p-5 text-center">
                   ...
                   <a href="login"><button class="btn fw-bold mb-5 btn-outline-success px-4 rounded-pill">log In</button></a>
...
<%--                            </div>
                           ...
                           <form:button class="btn btn-lg fw-bold fs-7 btn-success  w-100">Register</form:button>
                          <!--  </table> -->
